package com.ingenieur.andyelderscolls;
...
import com.ingenieur.andyelderscolls.nifdisplay.NifDisplayTester;
...
public class ElderScrollsActivity extends NewtBaseActivity
{
		...
		gl_window.addGLEventListener(new GLEventListener()
									 {
										 ...
										 public void init(@SuppressWarnings("unused") final GLAutoDrawable drawable)
										 {
											 try
											 {
												 ...
												 nifDisplay = new NifDisplayTester(ElderScrollsActivity.this, gl_window);
	...
	private void readSingleNifFIle()
	{
		...
		if (file.exists())
		{
			...
			try
			{
				...
				Toast.makeText(ElderScrollsActivity.this, "Dear lord nif file read in all " + nifFile.header, Toast.LENGTH_LONG)
						.show();
			}
			catch (IOException e)
			{
