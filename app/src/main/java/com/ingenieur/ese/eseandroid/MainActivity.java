package com.ingenieur.ese.eseandroid;
...
import com.ingenieur.ese.eseandroid.nifdisplay.NifDisplayTester;
...
public class MainActivity extends NewtBaseActivity
{
	...
	public void onCreate(final Bundle state)
	{
		...
		PrintStream interceptor = new Interceptor(System.out, "sysout");
		System.setOut(interceptor);
		PrintStream interceptor2 = new Interceptor(System.err, "syserr");
	...
	private void setupGLDisplay()
	{
		...
		//TODO: I must fix screen as horizontal about now
	...
	private void readSingleNifFIle()
	{
		...
		if (file.exists())
		{
			...
			try
			{
				...
				Toast.makeText(MainActivity.this, "Dear lord nif file read in all " + nifFile.header, Toast.LENGTH_LONG)
						.show();
			} catch (IOException e)
			{
	...
	void readExternalStoragePublicDcimESE()
	{
		...
		try
		{
			...
			Toast.makeText(MainActivity.this, "ESMManger loaded up", LENGTH_LONG).show();
...
/*
        ...
        try {
            ...
            Toast.makeText(MainActivity.this, "I just read in " +c+ " bytes of the ol' esm file there", LENGTH_LONG)
                    .show();
	...
	private class Interceptor extends PrintStream
	{
		...
		public Interceptor(OutputStream out, String tag)
		{
			super(out, true);
			this.tag = tag;
		}
