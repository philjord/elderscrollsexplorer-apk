		...
		public void display(final GLAutoDrawable drawable) {
			try {
				...
				if (!scrollsExplorerInitCalled) {
					...
					characterSheetOverlay = new GLWindowOverLay(getContext(), getView(),  R.layout.charactersheetoverlay, Gravity.LEFT | Gravity.TOP ,true);
					...
					inventoryOverlay = new GLWindowOverLay(getContext(), getView(),  R.layout.inventoryoverlay, Gravity.LEFT | Gravity.CENTER_VERTICAL ,true);
					...
					mapOverlay = new GLWindowOverLay(getContext(), getView(),  R.layout.mapoverlay, Gravity.RIGHT | Gravity.TOP ,true);
