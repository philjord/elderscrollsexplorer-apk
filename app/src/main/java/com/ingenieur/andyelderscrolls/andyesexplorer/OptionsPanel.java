...
public class OptionsPanel extends LinearLayout
{
	...
	public static class OptionsDialog extends AlertDialog
	{
		protected OptionsPanel optionsDialog;
		public OptionsDialog(final Activity activity, final AndySimpleWalkSetup simpleWalkSetup)
		{
			super(activity);
			this.setTitle("Options");
			optionsDialog = new OptionsPanel(activity, simpleWalkSetup);
			this.setContentView(optionsDialog);
	...
	public OptionsPanel(final Activity activity, final AndySimpleWalkSetup simpleWalkSetup)
	{
		super(activity);
		this.activity = activity;
		rootView = (ViewGroup) activity.getLayoutInflater().inflate(R.layout.dialog_options, null);
