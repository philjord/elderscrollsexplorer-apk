package com.ingenieur.andyelderscrolls.andyesexplorer.games.fallout4;
...
public class Fallout4MapImage extends MapFragment.MapImageInterface {

    public Fallout4MapImage(Context context, ScrollsExplorer scrollsExplorer, BsaTextureSource textureSource) {
