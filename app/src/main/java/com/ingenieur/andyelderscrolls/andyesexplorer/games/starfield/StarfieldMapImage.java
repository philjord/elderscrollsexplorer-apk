package com.ingenieur.andyelderscrolls.andyesexplorer.games.starfield;
...
public class StarfieldMapImage extends MapFragment.MapImageInterface {

    public StarfieldMapImage(Context context, ScrollsExplorer scrollsExplorer, BsaTextureSource textureSource) {
