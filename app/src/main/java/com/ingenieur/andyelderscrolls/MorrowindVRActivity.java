...
import com.ingenieur.andyelderscrolls.vr.WorldLayoutData;
 ...
 */
public class MorrowindVRActivity extends GvrActivity implements GvrView.Renderer {
  ...
  @Override
  public void onDrawFrame(HeadTransform headTransform, Eye leye, Eye reye) {
    ...
    Matrix.multiplyMM(view, 0, leye.getEyeView(), 0, camera, 0);
    ...
    float[] perspective = leye.getPerspective(Z_NEAR, Z_FAR);
