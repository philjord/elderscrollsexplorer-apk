...
public class KfDisplayActivity extends DisplayActivity {
        ...
        gl_window.addGLEventListener(new GLEventListener() {
                                         ...
                                         public void init(@SuppressWarnings("unused") final GLAutoDrawable drawable) {
                                             try {
                                                 ...
                                                 kfDisplay = new KfDisplayTester(KfDisplayActivity.this, gl_window, gameConfigToLoad.scrollsFolder);
                                                 canvas3D2D = kfDisplay.canvas3D2D;
